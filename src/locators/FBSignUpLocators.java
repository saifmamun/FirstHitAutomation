...
public class FBSignUpLocators {
	...
	public String fbemailLoactor ="//input[@name='email']";

	public String fbconfemailLocator = "//input[@name='email_confirmation__']";

	public String fbpasswordLoactor = "//input[@name= 'pass']";
